...
@HUBCOST       := 10000, -- Set the cost to be teleported to a primary hub (10000 = 1G)
@TOWNCOST       := 250000, -- Set the cost to warp to a zone-hub (250000 = 25G) 
@ZONECOST       := 500000, -- Set the cost to be teleported to a zone (500000 = 50G)
@POICOST        := 1000000, -- Set the cost to be teleported to a place of interest (1000000 = 100G)
@DUNGEONCOST    := 1000000, -- Set the cost to be teleported to a dungeon (1000000 = 100G)
@RAIDCOST       := 2500000, -- Set the cost to be teleported to a raid (2500000 = 250G)
...
(@ENTRY, @NAME, @SUBNAME, "Directions", @GOSSIP_MENU, 60, 60, 2, 35, 3, 1, 1.25, 1, 0, 2000, 8, 2, 7, 138936390, 0, 0, 0, "SmartAI", 0, 1, 0, 0, 1, 0, 2, '');
...
(@GOSSIP_MENU, 1, 2, "Stormwind", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Stormwind?"),
(@GOSSIP_MENU, 2, 2, "Orgrimmar", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Orgrimmar?"),
(@GOSSIP_MENU, 3, 2, "Darnassus", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Darnassus?"),
(@GOSSIP_MENU, 4, 2, "Ironforge", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Ironforge?"),
(@GOSSIP_MENU, 5, 2, "Exodar", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Exodar?"),
(@GOSSIP_MENU, 6, 2, "Thunder bluff", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Thunder bluff?"),
(@GOSSIP_MENU, 7, 2, "Undercity", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Undercity?"),
(@GOSSIP_MENU, 8, 2, "Silvermoon city", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Silvermoon city?"),
(@GOSSIP_MENU, 9, 2, "Dalaran", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Dalaran?"),
(@GOSSIP_MENU, 10, 2, "Shattrath", 1, 1, @GOSSIP_MENU, 0, 0, @HUBCOST, "Are you sure, that you want to go to Shattrath?"),
(@GOSSIP_MENU, 11, 2, "Booty bay", 1, 1, @GOSSIP_MENU, 0, 0, @TOWNCOST, "Are you sure, that you want to go to Booty bay?"),
(@GOSSIP_MENU, 12, 2, "Gurubashi arena", 1, 1, @GOSSIP_MENU, 0, 0, @POICOST, "Are you sure, that you want to go to Arena?"),
...
(@GOSSIP_MENU+1, 0, 2, "Gnomeregan", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Gnomeregan?"),
(@GOSSIP_MENU+1, 1, 2, "The Deadmines", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to The Deadmines?"),
(@GOSSIP_MENU+1, 2, 2, "The Stockade", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to The Stockade?"),
(@GOSSIP_MENU+1, 3, 2, "Ragefire Chasm", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Ragefire Chasm?"),
(@GOSSIP_MENU+1, 4, 2, "Razorfen Downs", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Razorfen Downs?"),
(@GOSSIP_MENU+1, 5, 2, "Razorfen Kraul", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Razorfen Kraul?"),
(@GOSSIP_MENU+1, 6, 2, "Scarlet Monastery", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Scarlet Monastery?"),
(@GOSSIP_MENU+1, 7, 2, "Shadowfang Keep", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Shadowfang Keep?"),
(@GOSSIP_MENU+1, 8, 2, "Wailing Caverns", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Wailing Caverns?"),
(@GOSSIP_MENU+1, 9, 2, "Blackfathom Deeps", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Blackfathom Deeps?"),
(@GOSSIP_MENU+1, 10, 2, "Blackrock Depths", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Blackrock Depths?"),
(@GOSSIP_MENU+1, 11, 2, "Blackrock Spire", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Blackrock Spire?"),
(@GOSSIP_MENU+1, 12, 2, "Dire Maul", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Dire Maul?"),
(@GOSSIP_MENU+1, 13, 2, "Maraudon", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Maraudon?"),
(@GOSSIP_MENU+1, 14, 2, "Scholomance", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Scholomance?"),
(@GOSSIP_MENU+1, 15, 2, "Stratholme", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Stratholme?"),
(@GOSSIP_MENU+1, 16, 2, "Sunken Temple", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Sunken Temple?"),
(@GOSSIP_MENU+1, 17, 2, "Uldaman", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Uldaman?"),
(@GOSSIP_MENU+1, 18, 2, "Zul'Farrak", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Zul'Farrak?"),
(@GOSSIP_MENU+1, 19, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+2, 0, 2, "Auchindoun", 1, 1, 0, 0, 0, @POICOST, "Are you sure, that you want to go to Auchindoun?"),
(@GOSSIP_MENU+2, 1, 2, "Caverns of Time", 1, 1, 0, 0, 0, @POICOST, "Are you sure, that you want to go to Caverns of Time?"),
(@GOSSIP_MENU+2, 2, 2, "Coilfang Reservoir", 1, 1, 0, 0, 0, @POICOST, "Are you sure, that you want to go to Coilfang Reservoir?"),
(@GOSSIP_MENU+2, 3, 2, "Hellfire Citadel", 1, 1, 0, 0, 0, @POICOST, "Are you sure, that you want to go to Hellfire Citadel?"),
(@GOSSIP_MENU+2, 4, 2, "Magisters' Terrace", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Magisters' Terrace?"),
(@GOSSIP_MENU+2, 5, 2, "Tempest Keep", 1, 1, 0, 0, 0, @POICOST, "Are you sure, that you want to go to Tempest Keep?"),
(@GOSSIP_MENU+2, 6, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+3, 0, 2, "Azjol-Nerub", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Azjol-Nerub?"),
(@GOSSIP_MENU+3, 1, 2, "The Culling of Stratholme", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to The Culling of Stratholme?"),
(@GOSSIP_MENU+3, 2, 2, "Trial of the Champion", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Trial of the Champion?"),
(@GOSSIP_MENU+3, 3, 2, "Drak'Tharon Keep", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Drak'Tharon Keep?"),
(@GOSSIP_MENU+3, 4, 2, "Gundrak", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Gundrak?"),
(@GOSSIP_MENU+3, 5, 2, "Icecrown Citadel Dungeons", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Icecrown Citadel Dungeons?"),
(@GOSSIP_MENU+3, 6, 2, "The Nexus Dungeons", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to The Nexus Dungeons?"),
(@GOSSIP_MENU+3, 7, 2, "The Violet Hold", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to The Violet Hold?"),
(@GOSSIP_MENU+3, 8, 2, "Halls of Lightning", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Halls of Lightning?"),
(@GOSSIP_MENU+3, 9, 2, "Halls of Stone", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Halls of Stone?"),
(@GOSSIP_MENU+3, 10, 2, "Utgarde Keep", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Utgarde Keep?"),
(@GOSSIP_MENU+3, 11, 2, "Utgarde Pinnacle", 1, 1, 0, 0, 0, @DUNGEONCOST, "Are you sure, that you want to go to Utgarde Pinnacle?"),
(@GOSSIP_MENU+3, 12, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+4, 0, 2, "Black Temple", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Black Temple?"),
(@GOSSIP_MENU+4, 1, 2, "Blackwing Lair", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Blackwing Lair?"),
(@GOSSIP_MENU+4, 2, 2, "Hyjal Summit", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Hyjal Summit?"),
(@GOSSIP_MENU+4, 3, 2, "Serpentshrine Cavern", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Serpentshrine Cavern?"),
(@GOSSIP_MENU+4, 4, 2, "Trial of the Crusader", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Trial of the Crusader?"),
(@GOSSIP_MENU+4, 5, 2, "Gruul's Lair", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Gruul's Lair?"),
(@GOSSIP_MENU+4, 6, 2, "Magtheridon's Lair", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Magtheridon's Lair?"),
(@GOSSIP_MENU+4, 7, 2, "Icecrown Citadel", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Icecrown Citadel?"),
(@GOSSIP_MENU+4, 8, 2, "Karazhan", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Karazhan?"),
(@GOSSIP_MENU+4, 9, 2, "Molten Core", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Molten Core?"),
(@GOSSIP_MENU+4, 10, 2, "Naxxramas", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Naxxramas?"),
(@GOSSIP_MENU+4, 11, 2, "Onyxia's Lair", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Onyxia's Lair?"),
(@GOSSIP_MENU+4, 12, 2, "Ruins of Ahn'Qiraj", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Ruins of Ahn'Qiraj?"),
(@GOSSIP_MENU+4, 13, 2, "Sunwell Plateau", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Sunwell Plateau?"),
(@GOSSIP_MENU+4, 14, 2, "The Eye", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to The Eye?"),
(@GOSSIP_MENU+4, 15, 2, "Temple of Ahn'Qiraj", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Temple of Ahn'Qiraj?"),
(@GOSSIP_MENU+4, 16, 2, "The Eye of Eternity", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to The Eye of Eternity?"),
(@GOSSIP_MENU+4, 17, 2, "The Obsidian Sanctum", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to The Obsidian Sanctum?"),
(@GOSSIP_MENU+4, 18, 2, "Ulduar", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Ulduar?"),
(@GOSSIP_MENU+4, 19, 2, "Vault of Archavon", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Vault of Archavon?"),
(@GOSSIP_MENU+4, 21, 2, "Zul'Gurub", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Zul'Gurub?"),
(@GOSSIP_MENU+4, 22, 2, "Zul'Aman", 1, 1, 0, 0, 0, @RAIDCOST, "Are you sure, that you want to go to Zul'Aman?"),
(@GOSSIP_MENU+4, 23, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+5, 0, 2, "Elwynn Forest", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Elwynn Forest?"),
(@GOSSIP_MENU+5, 1, 2, "Eversong Woods", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Eversong Woods?"),
(@GOSSIP_MENU+5, 2, 2, "Dun Morogh", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Dun Morogh?"),
(@GOSSIP_MENU+5, 3, 2, "Tirisfal Glades", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Tirisfal Glades?"),
(@GOSSIP_MENU+5, 4, 2, "Ghostlands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Ghostlands?"),
(@GOSSIP_MENU+5, 5, 2, "Loch modan", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Loch modan?"),
(@GOSSIP_MENU+5, 6, 2, "Silverpine Forest", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Silverpine Forest?"),
(@GOSSIP_MENU+5, 7, 2, "Westfall", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Westfall?"),
(@GOSSIP_MENU+5, 8, 2, "Redridge mountains", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Redridge mountains?"),
(@GOSSIP_MENU+5, 9, 2, "Duskwood", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Duskwood?"),
(@GOSSIP_MENU+5, 10, 2, "Hillsbrad Foothills", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Hillsbrad Foothills?"),
(@GOSSIP_MENU+5, 11, 2, "Wetlands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Wetlands?"),
(@GOSSIP_MENU+5, 12, 2, "Alterac Mountains", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Alterac Mountains?"),
(@GOSSIP_MENU+5, 13, 2, "Arathi Highlands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Arathi Highlands?"),
(@GOSSIP_MENU+5, 14, 2, "Stranglethorn Vale", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Stranglethorn Vale?"),
(@GOSSIP_MENU+5, 15, 2, "Badlands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Badlands?"),
(@GOSSIP_MENU+5, 16, 2, "Swamp of Sorrows", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Swamp of Sorrows?"),
(@GOSSIP_MENU+5, 17, 2, "The Hinterlands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to The Hinterlands?"),
(@GOSSIP_MENU+5, 18, 2, "Searing Gorge", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Searing Gorge?"),
(@GOSSIP_MENU+5, 19, 2, "The Blasted Lands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to The Blasted Lands?"),
(@GOSSIP_MENU+5, 20, 2, "Burning Steppes", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Burning Steppes?"),
(@GOSSIP_MENU+5, 21, 2, "Western Plaguelands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Western Plaguelands?"),
(@GOSSIP_MENU+5, 22, 2, "Eastern Plaguelands", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Eastern Plaguelands?"),
(@GOSSIP_MENU+5, 23, 2, "Isle of Quel'Danas", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Isle of Quel'Danas?"),
(@GOSSIP_MENU+5, 24, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+6, 0, 2, "Azuremyst Isle", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Azuremyst Isle?"),
(@GOSSIP_MENU+6, 1, 2, "Teldrassil", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Teldrassil?"),
(@GOSSIP_MENU+6, 2, 2, "Durotar", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Durotar?"),
(@GOSSIP_MENU+6, 3, 2, "Mulgore", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Mulgore?"),
(@GOSSIP_MENU+6, 4, 2, "Bloodmyst Isle", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Bloodmyst Isle?"),
(@GOSSIP_MENU+6, 5, 2, "Darkshore", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Darkshore?"),
(@GOSSIP_MENU+6, 6, 2, "The Barrens", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to The Barrens?"),
(@GOSSIP_MENU+6, 7, 2, "Stonetalon Mountains", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Stonetalon Mountains?"),
(@GOSSIP_MENU+6, 8, 2, "Ashenvale Forest", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Ashenvale Forest?"),
(@GOSSIP_MENU+6, 9, 2, "Thousand Needles", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Thousand Needles?"),
(@GOSSIP_MENU+6, 10, 2, "Desolace", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Desolace?"),
(@GOSSIP_MENU+6, 11, 2, "Dustwallow Marsh", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Dustwallow Marsh?"),
(@GOSSIP_MENU+6, 12, 2, "Feralas", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Feralas?"),
(@GOSSIP_MENU+6, 13, 2, "Tanaris Desert", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Tanaris Desert?"),
(@GOSSIP_MENU+6, 14, 2, "Azshara", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Azshara?"),
(@GOSSIP_MENU+6, 15, 2, "Felwood", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Felwood?"),
(@GOSSIP_MENU+6, 16, 2, "Un'Goro Crater", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Un'Goro Crater?"),
(@GOSSIP_MENU+6, 17, 2, "Silithus", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Silithus?"),
(@GOSSIP_MENU+6, 18, 2, "Winterspring", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Winterspring?"),
(@GOSSIP_MENU+6, 19, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+7, 0, 2, "Hellfire Peninsula", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Hellfire Peninsula?"),
(@GOSSIP_MENU+7, 1, 2, "Zangarmarsh", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Zangarmarsh?"),
(@GOSSIP_MENU+7, 2, 2, "Terokkar Forest", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Terokkar Forest?"),
(@GOSSIP_MENU+7, 3, 2, "Nagrand", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Nagrand?"),
(@GOSSIP_MENU+7, 4, 2, "Blade's Edge Mountains", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Blade's Edge Mountains?"),
(@GOSSIP_MENU+7, 5, 2, "Netherstorm", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Netherstorm?"),
(@GOSSIP_MENU+7, 6, 2, "Shadowmoon Valley", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Shadowmoon Valley?"),
(@GOSSIP_MENU+7, 7, 7, "Back..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+8, 0, 2, "Borean Tundra", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Borean Tundra?"),
(@GOSSIP_MENU+8, 1, 2, "Howling Fjord", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Howling Fjord?"),
(@GOSSIP_MENU+8, 2, 2, "Dragonblight", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Dragonblight?"),
(@GOSSIP_MENU+8, 3, 2, "Grizzly Hills", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Grizzly Hills?"),
(@GOSSIP_MENU+8, 4, 2, "Zul'Drak", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Zul'Drak?"),
(@GOSSIP_MENU+8, 5, 2, "Sholazar Basin", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Sholazar Basin?"),
(@GOSSIP_MENU+8, 6, 2, "Crystalsong Forest", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Crystalsong Forest?"),
(@GOSSIP_MENU+8, 7, 2, "Storm Peaks", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Storm Peaks?"),
(@GOSSIP_MENU+8, 8, 2, "Icecrown", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Icecrown?"),
(@GOSSIP_MENU+8, 9, 2, "Wintergrasp", 1, 1, 0, 0, 0, @ZONECOST, "Are you sure, that you want to go to Wintergrasp?"),
